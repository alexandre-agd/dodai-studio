    ...
    partnersPage: {
      ...
      personas: {
        ...
        p6: {
          ...
          text: "Your clients set up their GK, secure their Business Manager visa — then they're on their own facing the opening. Refer them to Dodai Studio to structure the operational side. We coordinate; you remain their trusted legal reference.",
        },
        p5: {
      ...
      process: {
        title: 'How it works',
        tag: '4 simple steps',
        s1: { t: 'Introduction', d: 'An email or a message — that\'s all it takes.' },
