    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dodai-charcoal">
            {t.journey?.title || "Le Parcours : Méthodique & Serein."}
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {t.journey?.subtitle || "Un processus structuré pour transformer une idée en actif rentable, étape par étape."}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="border-l-4 border-dodai-red pl-8 relative">
            ...
            <h4 className="text-2xl font-bold mb-4 text-dodai-charcoal">
              {t.journey?.phase1?.title || "Le Diagnostic — REALITY CHECK"}
            </h4>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              {t.journey?.phase1?.desc || "Le crash-test avant l'investissement. Nous auditons le plan, testons le concept sur le terrain et chiffrons le réel. Vous obtenez une certitude."}
            </p>
          ...
          <div className="border-l-4 border-dodai-charcoal pl-8 relative">
            ...
            <h4 className="text-2xl font-bold mb-4 text-dodai-charcoal">
              {t.journey?.phase2?.title || "Le Build — LES 4 PILIERS DE L'EXÉCUTION"}
            </h4>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              {t.journey?.phase2?.desc || "L'orchestration complète. Nous coordonnons simultanément les 4 chantiers critiques pour une ouverture sans friction."}
            </p>
          ...
          <div className="border-l-4 border-gray-300 pl-8 relative">
            ...
            <h4 className="text-2xl font-bold mb-4 text-dodai-charcoal">
              {t.journey?.phase3?.title || "Le Run — STABILISATION & CROISSANCE"}
            </h4>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              {t.journey?.phase3?.desc || "L'après-ouverture, c'est là que les affaires se gagnent ou se perdent. Nous restons pour le rodage, l'optimisation des marges et l'ancrage de la clientèle. Objectif : Rentabilité pérenne."}
            </p>
            <ul className="space-y-2 text-sm font-medium text-gray-700">
